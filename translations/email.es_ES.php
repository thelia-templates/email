...
return [
    ...
    'For any questions, feel free to contact us at %mail%.' => 'Para cualquier duda, puede escribirnos a %mail%.',
    ...
    'The status of your return %ref% has changed.' => 'El estado de su devolución %ref% ha cambiado.',
    'Thelia V2' => 'Thelia V2',
    ...
    'Update on your return %ref%' => 'Actualización de su devolución %ref%',
    ...
    'We have received the items of your return %ref%. It is being processed.' => 'Hemos recibido los artículos de su devolución %ref%. Se está procesando.',
    'We have received your return request %ref%. It is being reviewed.' => 'Hemos recibido su solicitud de devolución %ref%. Está siendo revisada.',
    'We need more information before we can process your return %ref%. Please get in touch with us so that we can move it forward.' => 'Necesitamos más información para poder procesar su devolución %ref%. Póngase en contacto con nosotros para que podamos continuar.',
    ...
    'Your return %ref% has been settled and is now closed.' => 'Su devolución %ref% se ha resuelto y ya está cerrada.',
    'Your return %ref% has expired and has been closed, as the items were not received. Please get in touch with us if you still wish to return them.' => 'Su devolución %ref% ha caducado y se ha cerrado, ya que no hemos recibido los artículos. Póngase en contacto con nosotros si todavía desea devolverlos.',
    'Your return request %ref% has been accepted. The items can now be sent back to us, and we will let you know as soon as we receive them.' => 'Su solicitud de devolución %ref% ha sido aceptada. Ya puede enviarnos los artículos; le avisaremos en cuanto los recibamos.',
    'Your return request %ref% has been refused.' => 'Su solicitud de devolución %ref% ha sido rechazada.',
];
