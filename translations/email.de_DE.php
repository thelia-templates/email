...
return [
    ...
    'For any questions, feel free to contact us at %mail%.' => 'Für Fragen erreichen Sie uns unter %mail%.',
    ...
    'The status of your return %ref% has changed.' => 'Der Status Ihrer Rücksendung %ref% hat sich geändert.',
    'Thelia V2' => 'Thelia V2',
    ...
    'Update on your return %ref%' => 'Update zu Ihrer Rücksendung %ref%',
    ...
    'We have received the items of your return %ref%. It is being processed.' => 'Wir haben die Artikel Ihrer Rücksendung %ref% erhalten. Sie wird bearbeitet.',
    'We have received your return request %ref%. It is being reviewed.' => 'Wir haben Ihre Rücksendeanfrage %ref% erhalten. Sie wird geprüft.',
    'We need more information before we can process your return %ref%. Please get in touch with us so that we can move it forward.' => 'Wir benötigen weitere Informationen, bevor wir Ihre Rücksendung %ref% bearbeiten können. Bitte nehmen Sie Kontakt mit uns auf, damit wir sie weiterbearbeiten können.',
    ...
    'Your return %ref% has been settled and is now closed.' => 'Ihre Rücksendung %ref% wurde abgeschlossen.',
    'Your return %ref% has expired and has been closed, as the items were not received. Please get in touch with us if you still wish to return them.' => 'Ihre Rücksendung %ref% ist abgelaufen und wurde geschlossen, da die Artikel nicht eingegangen sind. Bitte kontaktieren Sie uns, wenn Sie sie weiterhin zurücksenden möchten.',
    'Your return request %ref% has been accepted. The items can now be sent back to us, and we will let you know as soon as we receive them.' => 'Ihre Rücksendeanfrage %ref% wurde akzeptiert. Sie können uns die Artikel nun zurücksenden; wir melden uns, sobald sie bei uns eingetroffen sind.',
    'Your return request %ref% has been refused.' => 'Ihre Rücksendeanfrage %ref% wurde abgelehnt.',
];
