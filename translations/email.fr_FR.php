...
return [
    ...
    'Follow your order at %shop_name%' => 'Suivez votre commande sur %shop_name%',
    'Follow your order at %url%' => 'Suivez votre commande : %url%',
    'For any questions, feel free to contact us at %mail%.' => 'Pour toute question, vous pouvez nous écrire à %mail%.',
    ...
    'Reason given: %reason%' => 'Motif indiqué : %reason%',
    'Return Number:' => 'Retour N° :',
    ...
    'The status of your return %ref% has changed.' => 'Le statut de votre retour %ref% a changé.',
    'Thelia V2' => 'Thelia v2',
    ...
    'Update on your return %ref%' => 'Mise à jour de votre retour %ref%',
    ...
    'We have received the items of your return %ref%. It is being processed.' => 'Nous avons bien reçu les articles de votre retour %ref%. Il est en cours de traitement.',
    'We have received your return request %ref%. It is being reviewed.' => 'Nous avons bien reçu votre demande de retour %ref%. Elle est en cours d\'examen.',
    'We need more information before we can process your return %ref%. Please get in touch with us so that we can move it forward.' => 'Nous avons besoin d\'informations complémentaires pour traiter votre retour %ref%. Merci de nous contacter pour que nous puissions le faire avancer.',
    ...
    'Your return %ref% has been settled and is now closed.' => 'Votre retour %ref% a été réglé et est maintenant clôturé.',
    'Your return %ref% has expired and has been closed, as the items were not received. Please get in touch with us if you still wish to return them.' => 'Votre retour %ref% a expiré et a été clôturé : les articles ne nous sont pas parvenus. Contactez-nous si vous souhaitez toujours les renvoyer.',
    'Your return request %ref% has been accepted. The items can now be sent back to us, and we will let you know as soon as we receive them.' => 'Votre demande de retour %ref% a été acceptée. Vous pouvez nous renvoyer les articles ; nous vous préviendrons dès leur réception.',
    'Your return request %ref% has been refused.' => 'Votre demande de retour %ref% a été refusée.',
