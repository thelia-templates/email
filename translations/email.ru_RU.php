...
return [
    ...
    'For any questions, feel free to contact us at %mail%.' => 'По любым вопросам пишите нам на %mail%.',
    ...
    'The status of your return %ref% has changed.' => 'Статус вашего возврата %ref% изменился.',
    'Thelia V2' => 'Thelia V2',
    ...
    'Update on your return %ref%' => 'Обновление по вашему возврату %ref%',
    ...
    'We have received the items of your return %ref%. It is being processed.' => 'Мы получили товары по вашему возврату %ref%. Он обрабатывается.',
    'We have received your return request %ref%. It is being reviewed.' => 'Мы получили вашу заявку на возврат %ref%. Она рассматривается.',
    'We need more information before we can process your return %ref%. Please get in touch with us so that we can move it forward.' => 'Нам нужны дополнительные сведения, чтобы обработать ваш возврат %ref%. Пожалуйста, свяжитесь с нами, чтобы мы могли продолжить.',
    ...
    'Your return %ref% has been settled and is now closed.' => 'Ваш возврат %ref% урегулирован и закрыт.',
    'Your return %ref% has expired and has been closed, as the items were not received. Please get in touch with us if you still wish to return them.' => 'Срок вашего возврата %ref% истёк, и он закрыт: товары не были получены. Свяжитесь с нами, если вы всё ещё хотите их вернуть.',
    'Your return request %ref% has been accepted. The items can now be sent back to us, and we will let you know as soon as we receive them.' => 'Ваша заявка на возврат %ref% принята. Теперь вы можете отправить нам товары; мы сообщим, как только получим их.',
    'Your return request %ref% has been refused.' => 'Ваша заявка на возврат %ref% отклонена.',
