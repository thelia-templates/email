...
return [
    ...
    'Billing address:' => 'Adresse de facturation : ',
    'Click the link below, or copy it in your browser address bar, to choose it.' => 'Cliquez sur le lien ci-dessous, ou copiez-le dans la barre d\'adresse de votre navigateur, pour le choisir.',
    ...
    'If you did not ask for this, you can ignore this email: your password has not been changed.' => 'Si vous n\'êtes pas à l\'origine de cette demande, vous pouvez ignorer cet e-mail : votre mot de passe n\'a pas été modifié.',
    ...
    'Reset your password on %store%' => 'Réinitialisez votre mot de passe sur %store%',
    ...
    'Thelia V2' => 'Thelia v2',
    'This link can only be used once, and stops working %minutes% minutes after this email was sent.' => 'Ce lien n\'est utilisable qu\'une seule fois et cesse de fonctionner %minutes% minutes après l\'envoi de cet e-mail.',
    ...
    'You asked to choose a new password for your account at %store_name%' => 'Vous avez demandé à choisir un nouveau mot de passe pour votre compte %store_name%',
